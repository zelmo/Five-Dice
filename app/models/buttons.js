var ButtonModels = Class.create ({
	...
	threeOfAKind:	{label: "3 of a kind",		disabled: false},
	fourOfAKind:	{label: "4 of a kind",		disabled: false},
	fullHouse:		{label: "Full house",		disabled: false},
	smallStraight:	{label: "Sm. straight",		disabled: false},
	largeStraight:	{label: "Lg. straight",		disabled: false},
	fiveOfAKind:	{label: "5 of a kind",		disabled: false},
